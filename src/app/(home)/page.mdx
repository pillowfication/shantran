...
My job market paper investigates gender differences in the benefits of coauthoring with prominent economists. Using a diff-in-diff and matched sample design, I find that junior female economists who coauthor with female superstars experience significantly better outcomes than those who coauthor with male superstars. This highlights the importance of considering gender-specific factors to support women's success in economics.

Additionally, my research on scientific development in low- and middle-income countries examines the impact of research evaluation systems, social trust, and community engagement on scientific productivity. These works, published in _Research Policy_ and _Industry and Innovation_, contribute to the broader discourse on promoting global scientific equity.
...
<Button asChild>[Download PDF](/jmp)</Button>
</div>
...
<CollapsibleAbstract buttonText='View Abstract' className='md:text-sm'>
> Rising tuition and living expenses have intensified food insecurity among college students. This study examines the impact of campus food pantries on student outcomes. Using an institutional-level analysis, I leverage variation in pantry establishment timing to assess the impact on annual student retention rates. Additionally, an individual-level analysis, employing an instrumental variable approach with a randomized information intervention, assesses the impact of pantry use on student academic performance. By addressing this issue, this study contributes to understanding the efficacy of campus food pantries in improving student well-being and academic success.
</CollapsibleAbstract>
